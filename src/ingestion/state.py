...
class AppState:
    ...
    def __init__(self):
        ...
        # Reportes de normalización — generados en ingestion, leídos por /alertas
        self.normalization_reports: Dict[str, Dict] = {}

        # /modelo — flujo de cambio de modelo con API key
    ...
    def add_analysis(self, analysis_id: str, data: Dict[str, Any], df: pd.DataFrame, engine: AdlyEngine, dataset_info: Dict[str, Any], initial_msg: Dict[str, Any], normalization_report: Dict = None):
